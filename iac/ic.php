...
<div id="content-wrapper">
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-body">
            <div class="form-inline">
              <div class="col-md-12 form-group">
                <label class="col-sm-4 col-form-label">Complainant Name</label>
                <input class="form-control col-sm-6" type="text" id="cName">
              </div>
            </div>
            <br />
            <div class="form-inline">
            ...
            <div class="form-inline">
              <div class="col-md-12 form-group">
                ...
                <textarea class="form-control col-sm-6" id="deputiesInvolved"></textarea>
              </div>
            </div>
            <br />
            <div class="form-inline">
  ...
  <script type="text/javascript">
    ...
    function process() {
      ...
      var format =
        "[divbox=white][center][b][size=85]COUNTY OF LOS SANTOS SHERIFF'S DEPARTMENT[/size]\n\
        [size=90]INTERNAL AFFAIRS BUREAU — INVESTIGATION CONCLUSION[/size][/b][/center]\n\
        \n\
        \n\
        \n\
        To Whom It May Concern:\n\
        \n\
        Internal Affairs Bureau Investigation (REF NUMBER HERE) has been completed as of (" + momentJSdate + "). The facts are as follows:\n\
        \n\
        [u]Investigation Background[/u]\n\
        [table][tr]\n\
        [td][size=90][b]COMPLAINANT NAME[/b][/size][/td]\n\
        ...
        [tr][td][size=90]" + cName + "[/size][/td]\n\
        [td][size=90]" + date + "[/size][/td]\n\
        [td][size=90]" + deputiesInvolved + "[/size][/td]\n\
        [td][size=90]" + supervisingInvestigator + "[/size][/td][/tr][/table]\n\
        \n\
        [u]Allegations[/u]\n\
        [list=1]" + finalText + "[/list]\n\
        \n\
        [u]Recommendation[/u]\n\
        [table][tr][td][size=90][b]DEPUTY NAME[/b][/size][/td]\n\
        ...
        \n\
        [u]Evidence[/u]\n\
        [table][tr][td][size=90][b]EVIDENCE #[/b][/size][/td]\n\
        [td][size=90][b]DESC OF EVIDENCE[/b][/size][/td]\n\
        [td][size=90][b]INVESTIGATOR COMMENT[/b][/size][/td][/tr]\n\
        " + evidenceFinalText + "\n\
        [/table]\n\
        \n\
        [u]Bureau Command Approval[/u]\n\
        [table][tr][td][size=90][b]AUTHORIZING INVESTIGATOR[/b][/size][/td]\n\
        ...
        [td][size=90]" + furtherAction + "[/size][/td][/tr][/table]\n\
        [/divbox]";
