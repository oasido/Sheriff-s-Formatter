         ...
         <div id="content-wrapper">
            <div class="container-fluid">
                  ...
                  <div class="">
                     <div class="card">
                           <div class="card-header">
                              <strong>Disqualified Applicant</strong>
                           </div>
                           <div class="card-body">
                             ...
                             <div class="form-inline">
                               <div class="col-md-12 form-group">
                                 <label class="col-sm-4 col-form-label">Disq. Reason</label>
                                 <input class="form-control col-sm-6" type="text" id="reason">
                               </div>
                             </div>
                           </div>
                        </div>
               ...
               <div class="highlight-clean">
                  <div class="container" >
                     <center>
                        <button id="generate" class="btn btn-success btn-lg" onClick="process();"><i class="fas fa-cog"></i> Generate Form</button><br /><br />
            ...
            <script type="text/javascript">
               ...
               function process() {
                   ...
                   var reasonUp = reason.toUpperCase();
...
We have evaluated your application and qualifications for the position of Deputy Sheriff Trainee and regret to inform you that you were not selected for this position due to issues involving `+reasonUp+`.

This disqualification may be permanent. However, under all circumstances, you are ineligible to reapply or take the written examination during the current recruitment drive.

[b]Any formal appeal must be in writing and received by Training Bureau Command within ten (10) business days from the [u]postmark date[/u] of this letter.

To appeal, you must demonstrate that the factors leading to your disqualification are in error.[/b]
...
[center][img]https://www.upload.ee/image/11509874/footer.png[/img][/center][/divbox]`;
                  ...
                  //  var dummy = $('<input>').val(format).appendTo('body').select()
