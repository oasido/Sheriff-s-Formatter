                  ...
                  <div class="">
                     <div class="card">
                           <div class="card-header">
                              <strong>Applicant's Action Needed</strong>
                           </div>
                           <div class="card-body">
                             ...
                             <form action="index.html" method="post">
                               <div class="input_fields_container_part">
                                 <!-- container to dupe -->
                                 <!-- <br /> -->
                                 <center>Pending Reason(s)</center>
                                 <br>
                                 <div class="form-inline">
                                   <div class="col-md-12 form-group">
                                     <label class="col-sm-4 col-form-label">1.</label>
                                     <input name="pendReasons" type="text" value="" class="form-control col-sm-6"/>
                                   </div>
                                 </div>
                                 <div class="aye"></div>
                               </div>
            ...
            $(document).ready(function () {
              ...
              $('.add_more_button').click(function (e) { //click event on add more fields button having class add_more_button
                ...
                if (x < max_fields_limit) { //check conditions
                  ...
                  $('.aye').append(
                    ...
                    ".</label><input name='pendReasons' type='text' value='' class='form-control col-sm-6'/></div></div></div>"
                  ); //add input field
                }
              });
              ...
              $('.remove_field').on('click', function (e) { //user click on remove text links
               ...
               function process() {
                   ...
                   // for the reasons of pending
                   var values = [];
                   $("input[name='pendReasons']").each(function () {
...
We have reviewed your application and qualifications for the position of Deputy Sheriff Trainee.

We have noticed a discrepancy in your application and may not process it further. The following issue(s) must first be corrected:
[list]
`+values.join("").toUpperCase()+`
[/list]
You have 24 hours to correct the aforementioned issue(s). Once corrected, you must forward a reply slip stating that amendments have been made.
