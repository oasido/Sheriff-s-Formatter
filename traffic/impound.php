...
<link href="/css/custom-checkbox.scss" rel="stylesheet" type="text/css">
        ...
        <div id="content-wrapper">
                            ...
                            <div class="card-body">
                              ...
                              <div class="form-inline">
                                <div class="col-md-12 form-group">
                                  ...
                                  <label for="a4">
                                    Illegal Nitrous Oxide Possession
                                  </label>
                                </div>
                              </div>
                              <!-- <br /> -->
                              ...
                              <div class="form-inline">
                                <div class="col-md-12 form-group">
                                  ...
                                  <label for="a10">
                                    Unlawful Transport of Persons in Cargo Area
                                  </label>
                                </div>
                              </div>
                              <!-- <br /> -->
                              <div class="form-inline">
                                <div class="col-md-12 form-group">
                                  <input onclick="showThisUponClick()" type="checkbox" id="a11"/>
                                  <label for="a11">
                                    Other
                                  </label>
                                  <div style="display: none;" id="hideOrShow">
                                    <textarea cols="50" class="form-control col-sm-10 float-right" rows="3" id="other" placeholder="Currently blank, please either tick the checkbox and type the violations, or type 'N/A'">N/A</textarea>
                                  </div>
                                </div>
                              </div>
                            </div>
            ...
            function showThisUponClick() {
              // Get the checkbox
              var checkBox = document.getElementById("a11");
              var showThisPart = document.getElementById("hideOrShow");
              // If the checkbox is checked, display the output text
              if (checkBox.checked == true){
                showThisPart.style.display = "block";
              } else {
                showThisPart.style.display = "none";
              }
            }
